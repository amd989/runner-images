...
# Download GitHub CLI
gh_cli_url=$(resolve_github_release_asset_url "cli/cli" "contains(\"linux\") and contains(\"${GH_ARCH}\") and endswith(\".deb\")" "latest")
...
external_hash=$(get_checksum_from_url "$hash_url" "linux_${GH_ARCH}.deb" "SHA256")
